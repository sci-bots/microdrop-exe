...
%~dp0\microdrop-config edit --set dmf_device_ui_plugin.surface_alphas "{""background"":1.0,""shapes"":1.0,""connections"":0.0,""routes"":1.0,""channel_labels"":1.0,""static_electrode_state_shapes"":0.3,""dynamic_electrode_state_shapes"":0.7,""registration"":0.0}"
